...
class CustomTrafficGraph extends TrafficGraph {
  constructor (name, mainView, parentGraph, graphWidth, graphHeight, Layout = RingCenterLayout, entryNode = undefined, connectionType = undefined) {
    super(name, mainView, parentGraph, graphWidth, graphHeight, CustomNode, connectionType === 'global' ? GlobalConnection : RegionConnection, Layout, entryNode);
    this.type = 'custom';
...
export default CustomTrafficGraph;
